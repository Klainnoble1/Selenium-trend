...
json_body_expr = '={{ {"model":"mistralai/Mistral-7B-Instruct-v0.3","messages":[{"role":"system","content":"You rewrite news summaries into SEO blog posts and return strict JSON with keys: title, blog_content, tags, meta_description."},{"role":"user","content":"Topic: " + ($json.keyword || "") + "\\n\\nContent:\\n" + ($json.summary_for_ai || "") }],"temperature":0.7,"max_tokens":1400} }}'
